...
public void insertAfter(Object item) throws InvalidNodeException {
    if (!isValidNode()) {
      throw new InvalidNodeException("insertAfter() called on invalid node");
    	...
    	//set pointers
    	DListNode toInsert = new DListNode(item, (DList) this.myList, this, this.next);
    	this.next.prev = toInsert;
    	this.next = toInsert;
    }
...
public void insertBefore(Object item) throws InvalidNodeException {
    ...
    DListNode toInsert = new DListNode(item, (DList) this.myList, this.prev, this);
    this.prev.next = toInsert;
    this.prev = toInsert;
...
public void remove() throws InvalidNodeException {
    if (!isValidNode()) {
      throw new InvalidNodeException("remove() called on invalid node");
    	...
    	//move pointers around to skip this node
