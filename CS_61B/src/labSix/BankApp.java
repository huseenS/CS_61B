	    ...
	    try {
		    ...
		    while (!command.equals("quit")) {
		    	try {
					...
					System.err.println(e+System.getProperty("line.separator"));
					 command = bankApp.readLine("--> ");
 ...
 * @throws BadAccountException 
  */
  private void doDeposit() throws IOException, BadAccountException, NumberFormatException {
    // Get account number.
 ...
 * @throws BadTransactionException
   */
  private void doWithdraw() throws IOException, BadAccountException, NumberFormatException, BadTransactionException {
    // Get account number.
    int acctNumber = readInt("Enter account number: ");
   ...
   *  @exception IOException if there are problems reading user input.
   */
  private void doInquire() throws IOException, BadAccountException, NumberFormatException{
    int acctNumber = readInt("Enter account number: ");
